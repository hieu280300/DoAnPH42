                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="home">
                                                <div class="single_p_image">
                                                    <a href="{{ $product->thumbnail }}" data-lightbox="image-1"
                                                        data-title="My caption"><img src="{{ $product->thumbnail }}"
                                                            alt="" /></a>
                                                    <img id="zoom_02" src="{{ $product->thumbnail }}"
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="profile">
                                                <div class="single_p_image">
                                                    <a href="{{ $product->thumbnail }}" data-lightbox="image-1"
                                                        data-title="My caption"><img src="{{ $product->thumbnail }}"
                                                            alt="" /></a>
                                                    <img id="zoom_03" src="{{ $product->thumbnail }}"
                                                        data-zoom-image="{{ $product->thumbnail }}" alt="" />
                                                </div>
                                            </div>
                                            <div role="tabpanel" class="tab-pane" id="messages">
                                                <div class="single_p_image">
                                                    <a href="{{ $product->thumbnail }}" data-lightbox="image-1"
                                                        data-title="My caption"><img src="{{ $product->thumbnail }}"
                                                            alt="" /></a>
                                                    <img id="zoom_04" src="{{ $product->thumbnail }}"
                                                        data-zoom-image="{{ $product->thumbnail }}" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="panel-group product_accordion" id="home-accordion-single" role="tablist"
                                        ...
                                        <div class="panel-heading product_accordion_heading" role="tab" id="headingTwoP">
                                            <h4 class="panel-title product_accordion_head">
                                                <a class="collapsed" data-toggle="collapse"
                                                    data-parent="#home-accordion-single" href="#collapseTwoP"
                                    ...
                                    <div class="panel panel-default product_default">
                                        <div class="panel-heading product_accordion_heading" role="tab" id="headingThreeP">
                                            <h4 class="panel-title product_accordion_head">
                                                <a class="collapsed" data-toggle="collapse"
                                                    data-parent="#home-accordion-single" href="#collapseThreeP"
                                        ...
                                        <div id="collapseThreeP" class="panel-collapse collapse" role="tabpanel"
                                                ...
                                                <div class="color_detail">
                                                    <div class="size_down">
                                                        <input type="number" size="4" class="input-text qty text"
                                                            title="Qty" value="1" name="qty" max="119" min="1" step="1">
                                                    </div>
                            ...
                            <div class="tab-content tab-p-details">
                                <div role="tabpanel" class="tab-pane active" id="home2">
                                    ...
                                    <p>Totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto
                                        beatae vitae dicta sunt explicabo. Nemo enimsal ipsam salamthi voluptatem quia
                                        voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos
                                        qui ratione voluptateras sequi nesciunt resmla Neque porro quisquam est, qui dolorem
                                        ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquae eius
                                        modi tempora inciduntia ut labore et dolore magnam aliquam quaerat voluptatem.
                                    </p>
                                </div>
                                        ...
                                        <div class="single_review_comment">
                                            ...
                                            <div class="single_review_text">
                                                ...
                                                <p>Semper orci etiam ac ultricies ante. Donec lobortis variusjusto et.
                                                    ...
                                                    Aliquam erat volutpat. Suspendisse potenti. Nullam porta faucibus elit.
                                                </p>
