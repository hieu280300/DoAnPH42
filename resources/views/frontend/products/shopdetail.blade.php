...
@push('js')
    <script>
        var AJAX_PRODUCT_CHECK_QUANTITY_URL = "{{ route('check-quantity', request()->route('id')) }}";
    </script>
    <script src="/js/frontend/rs-plugin/check_quantity.js"></script>
@endpush
@section('content')
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="bread_box">
                        <ul class="breadcumb">
                            ...
                            <li><a href="{{route('shop')}}">Product<span>|</span></a></li>
                            <li class="active"><a href="category-1.html">Product-details</a></li>
                                      ...
                                      <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="home">
                                            <div class="single_p_image">
                                                <a href="{{$product->thumbnail}}" data-lightbox="image-1" data-title="My caption" ><img src="/images/frontend/product-plus.png" alt="" style="" /></a>
                                                <img id="zoom_02" src="{{$product->thumbnail}}" data-zoom-image="{{$product->thumbnail}}" alt="" style="height:450px;width:346px"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel panel-default product_default">
                                        ...
                                        <form action="{{ route('add_cart', $product->id) }}" method="post" id="frm-add-cart">
                                            ...
                                            <div class="action">
                                                ...
                                                <button class="add-to-cart btn btn-default" type="submit"> <i class="fa fa-shopping-cart"> Add to cart</i></button>
                                            </div>
                                        </form>
                                    </div>
